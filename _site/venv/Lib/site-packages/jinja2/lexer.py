...
class TokenStream:
    ...
    def expect(self, expr: str) -> Token:
        ...
        if not self.current.test(expr):
            ...
            raise TemplateSyntaxError(
                f"expected token {expr!r}, got {
                    describe_token(self.current)!r}",
                self.current.lineno,
                self.name,
                self.filename,
            )
    ...
    def tokeniter(
        ...
        while True:
            ...
            # either we are at the end of the file or we have a problem
                ...
                raise TemplateSyntaxError(
                    f"unexpected char {source[pos]!r} at {
                        pos}", lineno, name, filename
                )
